...
class ValidateElecDistributor implements Rule
{
    /**
    ...
    public function passes($attribute, $value)
    {
        ...
        if($distributorId){
            $data = Distributor::where('id',$distributorId)->where('energy_type',1)->where('status',1)->with(
    ...
    {
        return 'Please enter valid electricity distributor_id.';
    }
}
